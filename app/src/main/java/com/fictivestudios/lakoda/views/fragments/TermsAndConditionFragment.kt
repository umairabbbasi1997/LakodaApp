...
class TermsAndConditionFragment : BaseFragment() {
    ...
    override fun setTitlebar(titlebar: Titlebar) {
            titlebar.setBtnBack(getString(R.string.terms_and_con_))
    }
    ...
    override fun onCreateView(
       ...
       mView = inflater.inflate(R.layout.fragment_terms_and_condition, container, false)
    ...
    private fun getTerms()
    {
       ...
       mView.pb_t_and_c.visibility=View.VISIBLE
        ...
        GlobalScope.launch(Dispatchers.IO)
        {
            ...
            apiClient.getContent("tc").enqueue(object: retrofit2.Callback<ContentResponse> {
                    ...
                    try {
                        ...
                        if (response.isSuccessful) {
                            ...
                            if (response.body()?.status==1)
                            {
                                ...
                                {
                                    mView.text_tc.setText(response.body()!!.data.content.content)
                                }
